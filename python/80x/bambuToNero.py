...
whichTrigger = 'none'
try:
    whichTrigger  = analysis.custom['trigger']
except KeyError:
    whichTrigger = "-"
...
jecVersion = switchBX('Spring16_25nsV6', 'Summer15_50nsV5')
...
metSkim = mithep.MonoXSkimMod('MetSkim',
    ...
    MinMetPt = (20000. if doFilter else 0.)
)
...
triggers = [
  ...
  ('Ele30_WPTight_Gsf', ['hltEle30WPTightGsfTrackIsoFilter']),
  ...
  ('IsoMu27', ['hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p09']),
  ...
  ('IsoTkMu27', ['hltL3fL1sMu22Or25L1f0Tkf27QL3trkIsoFiltered0p09']),
  ('Mu45_eta2p1', ['hltL3fL1sMu22Or25L1f0L2f10QL3Filtered45e2p1Q']),
  ('Mu50', ['hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q']),

  ('Photon36_R9Id90_HE10_IsoM', ['hltEG36R9Id90HE10IsoMTrackIsoFilter']),
