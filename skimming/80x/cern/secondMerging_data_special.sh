...
root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$WORKDIR/data1_${ERA}.root\",\"$WORKDIR/data1_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$WORKDIR/data2_${ERA}.root\",\"$WORKDIR/data2_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$WORKDIR/data3_${ERA}.root\",\"$WORKDIR/data3_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
