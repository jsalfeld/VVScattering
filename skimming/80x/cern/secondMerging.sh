...
export JSONFILE=VVScattering/json/80x/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt;
...
#root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/MET_${ERA}.root\",\"$OUTPUTDIR/MET_${ERA}.root\",\"$JSONFILE\"\);
#root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/photon_${ERA}.root\",\"$OUTPUTDIR/photon_${ERA}.root\",\"$JSONFILE\"\);
#root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/data_${ERA}.root\",\"$OUTPUTDIR/data_${ERA}.root\",\"$JSONFILE\"\);
#root -l -q -b VVScattering/skimming/80x/makeOneSkimSample.C+\(\"$OUTPUTDIR/data_${ERA}.root\",\"$OUTPUTDIR/met_data_${ERA}.root\",\"data\",2\);

###root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/MET_${ERA}.root\",\"$WORKDIR/MET_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
###xrdcp $WORKDIR/MET_GOODRUN_${ERA}.root $OUTPUTDIR/MET_GOODRUN_${ERA}.root;
###rm -f $WORKDIR/MET_GOODRUN_${ERA}.root;

###root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/photon_${ERA}.root\",\"$WORKDIR/photon_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
###xrdcp $WORKDIR/photon_GOODRUN_${ERA}.root $OUTPUTDIR/photon_GOODRUN_${ERA}.root;
###rm -f $WORKDIR/photon_GOODRUN_${ERA}.root;

root -l -q -b VVScattering/skimming/80x/makeGoodRunSample.C+\(\"$MERGINGDIREOS/data_${ERA}.root\",\"$WORKDIR/data_GOODRUN_${ERA}.root\",\"$JSONFILE\"\);
xrdcp $WORKDIR/data_GOODRUN_${ERA}.root $OUTPUTDIR/data_GOODRUN_${ERA}.root;
rm -f $WORKDIR/data_GOODRUN_${ERA}.root;

###root -l -q -b VVScattering/skimming/80x/makeOneSkimSample.C+\(\"$OUTPUTDIR/MET_GOODRUN_${ERA}.root\",\"$WORKDIR/MET_${ERA}.root\",\"data\",0\);
###xrdcp $WORKDIR/MET_${ERA}.root $OUTPUTDIR/MET_${ERA}.root;
###rm -f $WORKDIR/MET_${ERA}.root;

###root -l -q -b VVScattering/skimming/80x/makeOneSkimSample.C+\(\"$OUTPUTDIR/photon_GOODRUN_${ERA}.root\",\"$WORKDIR/photon_${ERA}.root\",\"data\",0\);
###xrdcp $WORKDIR/photon_${ERA}.root $OUTPUTDIR/photon_${ERA}.root;
###rm -f $WORKDIR/photon_${ERA}.root;

root -l -q -b VVScattering/skimming/80x/makeOneSkimSample.C+\(\"$OUTPUTDIR/data_GOODRUN_${ERA}.root\",\"$WORKDIR/data_${ERA}.root\",\"data\",0\);
xrdcp $WORKDIR/data_${ERA}.root $OUTPUTDIR/data_${ERA}.root;
rm -f $WORKDIR/data_${ERA}.root;

root -l -q -b VVScattering/skimming/80x/makeOneSkimSample.C+\(\"$OUTPUTDIR/data_GOODRUN_${ERA}.root\",\"$WORKDIR/met_data_${ERA}.root\",\"data\",2\);
