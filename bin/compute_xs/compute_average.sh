...
grep -e Successfully -e "After filter" log|awk '{split($7,a,"store/mc/RunIISummer16MiniAODv2/");split(a[2],b,"/"); if($4=="Successfully")printf("%s ",b[1]);if($1=="After")printf("%20.15f %20.15f\n",$7,$9);}' > log_xs;
