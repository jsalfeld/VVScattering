...
--nentries=$1 --book=t2mit/filefi/043 --dataset=$2 $3 --custom bx=25ns pdfrwgt=pwhg_74 \
--fileset=0000 --output=test.root $CMSSW_BASE/src/VVScattering/python/76x/bambuToNero.py;
