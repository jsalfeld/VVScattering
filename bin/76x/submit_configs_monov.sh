...
./runOnDatasets.py --cfg=$CMSSW_BASE/src/MitAnalysisRunII/configs/76x/monov_all.txt \
--condor-template=$CMSSW_BASE/src/NeroProducer/Bambu/config/condor_template.jdl \
--analysis=$CMSSW_BASE/src/MitAnalysisRunII/python/76x/bambuToNero_monov.py;
