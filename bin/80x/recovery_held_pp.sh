...
cp $CMSSW_BASE/src/VVScattering/bin/80x/submit_configs_pp.sh submit_configs_temp.sh;
sed -i 's|--analysis=$CMSSW_BASE/src/VVScattering/python/80x/bambuToNero.py|--update --name=pp_all|' submit_configs_temp.sh;
