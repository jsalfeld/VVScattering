...
cp $CMSSW_BASE/src/MitAnalysisRunII/bin/80x/submit_configs_pp.sh submit_configs_temp.sh;
sed -i 's|--analysis=$CMSSW_BASE/src/MitAnalysisRunII/python/80x/bambuToNero.py|--update --name=pp_all|' submit_configs_temp.sh;
