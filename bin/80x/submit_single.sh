...
--nentries=$1 --book=t2mit/filefi/044 --dataset=$2 $3 --custom bx=25ns pdfrwgt=pwhg_74 \
--fileset=0013 --output=test.root $CMSSW_BASE/src/MitAnalysisRunII/python/80x/bambuToNero.py;
