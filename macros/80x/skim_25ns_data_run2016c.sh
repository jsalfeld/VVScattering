...
root -l -q -b MitAnalysisRunII/macros/80x/makeOneSkimSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/MuonEG+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/temp/MuonEG+Run2016C-PromptReco-v2+AOD.root\",\"data\"\)
root -l -q -b MitAnalysisRunII/macros/80x/makeOneSkimSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/DoubleMuon+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/temp/DoubleMuon+Run2016C-PromptReco-v2+AOD.root\",\"data\"\)
root -l -q -b MitAnalysisRunII/macros/80x/makeOneSkimSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/SingleMuon+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/temp/SingleMuon+Run2016C-PromptReco-v2+AOD.root\",\"data\"\)
root -l -q -b MitAnalysisRunII/macros/80x/makeOneSkimSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/DoubleEG+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/temp/DoubleEG+Run2016C-PromptReco-v2+AOD.root\",\"data\"\)
root -l -q -b MitAnalysisRunII/macros/80x/makeOneSkimSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/SingleElectron+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/temp/SingleElectron+Run2016C-PromptReco-v2+AOD.root\",\"data\"\)
...
#root -l -q -b MitAnalysisRunII/macros/80x/makeGoodRunSample.C+\(\"/data/t3home000/ceballos/merging_ntuples/MuonEG+Run2016C-PromptReco-v2+AOD.root\",\"/scratch/ceballos/ntuples_goodrun_80x/MuonEG+Run2016C-PromptReco-v2+AOD.root\",\"MitAnalysisRunII/json/80x/Cert_271036-276811_13TeV_PromptReco_Collisions16_JSON.txt\"\)
