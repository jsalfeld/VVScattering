 ...
 TString type3rdLepSel = "default"
  ...
  Int_t period = 1;
   TString filesPathDA  = "/scratch/ceballos/ntuples_weightsDA_76x/met_";
    ...
    TString filesPathMC80x  = "/scratch5/ceballos/ntuples_weightsMC_80x/met_";
...
//  TString filesPathDA  = "root://eoscms//eos/cms/store/user/jsalfeld/HWZ_Study/data/met_";
  ...
  TString puPath = "";
  if      (period==1){
  puPath = "VVScattering/data/80x/puWeights_80x_13p0ifb.root";
  ...
  //       infilenamev.push_back("/scratch/jsalfeld/met_data_Run2016B.root");  infilecatv.push_back(0);
  //   infilenamev.push_back("/scratch/jsalfeld/met_data_Run2016C.root");  infilecatv.push_back(0);
  //   infilenamev.push_back("/scratch/jsalfeld/met_data_Run2016D.root"); infilecatv.push_back(0);
     infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016B.root");  infilecatv.push_back(0);
     infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016C.root");  infilecatv.push_back(0);
     infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016D.root"); infilecatv.push_back(0);
       //infilenamev.push_back("/scratch5/dhsu/ntuples_goodrun_80x/met_data_Run2016B_skim.root");  infilecatv.push_back(0);
       //infilenamev.push_back("/scratch5/dhsu/ntuples_goodrun_80x/met_data_Run2016C_skim.root");  infilecatv.push_back(0);
       //infilenamev.push_back("/scratch5/dhsu/ntuples_goodrun_80x/met_data_Run2016D_skim.root"); infilecatv.push_back(0);     
   //
  //   infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_2p6ifb.root");  infilecatv.push_back(0);
...
infilenamev.push_back(Form("%sTT_TuneCUETP8M1_13TeV-powheg-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12_ext3-v1+AODSIM.root",filesPathMC.Data()));
  ...
  infilenamev.push_back(Form("%sWJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));		   infilecatv.push_back(1);
  ...
  infilenamev.push_back(Form("%sZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));                   infilecatv.push_back(2);

  infilenamev.push_back(Form("%sWZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(3);
  ...
  //	infilenamev.push_back(Form("%sWZJJ_EWK_13TeV-madgraph-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));	       infilecatv.push_back(3);
	...
	infilenamev.push_back("/scratch5/ceballos/ntuples_weightsMC_80x/met_WLLJJToLNu_M-60_EWK_13TeV-madgraph-pythia8+RunIISpring16DR80-premix_withHLT_80X_mcRun2_asymptotic_v14-v1+AODSIM.root"); infilecatv.push_back(3);

  infilenamev.push_back(Form("%sZZTo4L_13TeV_powheg_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo2mu2tau_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo4e_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo4mu_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo4tau_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo2mu2nu_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(4);
  infilenamev.push_back(Form("%sGluGluToContinToZZTo2e2nu_13TeV_MCFM701_pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(4);

  infilenamev.push_back(Form("%sWWW_4F_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(5);
  infilenamev.push_back(Form("%sWWZ_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));                           infilecatv.push_back(5);
  infilenamev.push_back(Form("%sWZZ_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));                           infilecatv.push_back(5);
  infilenamev.push_back(Form("%sZZZ_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));                         infilecatv.push_back(5);
  infilenamev.push_back(Form("%sTTWJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(5);
  infilenamev.push_back(Form("%sTTWJetsToQQ_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(5);
  infilenamev.push_back(Form("%sTTZToLLNuNu_M-10_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(5);
  infilenamev.push_back(Form("%sTTZToQQ_TuneCUETP8M1_13TeV-amcatnlo-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));   infilecatv.push_back(5);
  infilenamev.push_back(Form("%sTTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));           infilecatv.push_back(5);
  //infilenamev.push_back(Form("%stZq_nunu_4f_13TeV-amcatnlo-pythia8_TuneCUETP8M1+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));    infilecatv.push_back(5);
  infilenamev.push_back(Form("%stZq_ll_4f_13TeV-amcatnlo-pythia8_TuneCUETP8M1+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root",filesPathMC80x.Data()));            infilecatv.push_back(5);
...
*/ 
 ...
 infilenamev.push_back("/scratch/jsalfeld/met_VBFSignal_"+SignalSuffix[i]+"_80X.root");infilecatv.push_back(6);
 cout<<SignalSuffix[i]<<endl;
  ...
  //		infilenamev.push_back(Form("%sWZJJ_QCD_13TeV-madgraph-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data()));	       infilecatv.push_back(3);
      //  infilenamev.push_back("/scratch5/ceballos/ntuples_weightsMC_80x/met_WLLJJToLNu_M-60_EWK_13TeV-madgraph-pythia8+RunIISpring16DR80-premix_withHLT_80 \
		//X_mcRun2_asymptotic_v14-v1+AODSIM.root"); infilecatv.push_back(3);
  //  infilenamev.push_back(Form("%sWZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8+RunIISpring16DR80-PUSpring16_80X_mcRun2_asymptotic_2016_v3-v1+AODSIM.root ",filesPathMC80x.Data()));   infilecatv.push_back(4);

  //infilenamev.push_back("/scratch5/ceballos/ntuples_weightsMC_80x/met_ZZJJTo4L_EWK_13TeV-madgraph-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root"); infilecatv.push_back(5);
  //        infilenamev.clear();infilecatv.clear();
  // infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016B.root");  infilecatv.push_back(0);
  //    infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016C.root");  infilecatv.push_back(0);
  //       infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016D.root"); infilecatv.push_back(0);
  ...
  //  infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016B.root");  infilecatv.push_back(0);
  //  infilenamev.push_back("/scratch/ceballos/ntuples_weightsDA_80x/met_data_Run2016C.root");  infilecatv.push_back(0);
  // infilenamev.push_back("/scratch/jsalfeld/VBFWZ_76X_13TeV_Signal/met_SignalM700_80x.root");infilecatv.push_back(6);
   
  //infilenamev.push_back(Form("%sWZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v2+AODSIM.root",filesPathMC.Data()));    infilecatv.push_back(3);
  //infilenamev.push_back(Form("%sWZJJ_EWK_QCD_13TeV-madgraph-pythia8+RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1+AODSIM.root",filesPathMC.Data())); infilecatv.push_back(3);
	    //  infilenamev.push_back(Form("%sVBFHiggs_SignalM700_New.root",filesPathMCSig.Data()));           infilecatv.push_back(6);//
  //	    infilenamev.push_back(Form("/scratch/jsalfeld/met_VBFSignal_M700_80X.root"));infilecatv.push_back(6);
  //for(int i=0; i<9;i++){
  //infilenamev.push_back(Form("%sVBFHiggs_Signal"+SignalSuffix[i]+"_New.root",filesPathMCSig.Data()));           infilecatv.push_back(6);
     // }
...
delete fFakeShape;
  ...
  delete fPUFile;
   ...
   TFile *fTrackElectronReco_SF = TFile::Open(Form("VVScattering/data/80x/scalefactors_80x_egpog_13p0ifb.root"));
   ...
   TFile *fElSF = TFile::Open(Form("VVScattering/data/80x/scalefactors_80x_egpog_13p0ifb.root"));
   ...
   //TFile *fMuSF = TFile::Open(Form("VVScattering/data/80x/scalefactors_80x.root"));
  ...
  for(UInt_t ifile=0; ifile<infilenamev.size(); ifile++) {
	...
	histo_WZ_CMS_QCDScaleInitial[5] = histo_WZ_CMS_QCDScaleInitial[5] + TMath::Abs((double)eventMonteCarlo.r5f5);
      ...
      if(eventLeptons.p4->GetEntriesFast() >= 2 &&
	      ...
	      if(infilecatv[ifile] == 0){
		if((strcmp(tokens[nt],"HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v*")  == 0) ||
		...
		//cout<<"here"<<endl;
     	if((strcmp(tokens[nt],"HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL_v*")  == 0) ||
           ...
           ) passFilter[1] = kTRUE; //cout<<"fired"<<endl;
	      }
	   }
	    //passFilter[1]=kTRUE;
	...
	TMath::Abs((int)(*eventLeptons.pdgId)[nlep]),TMath::Abs(((TLorentzVector*)(*eventLeptons.p4)[nlep])->Pt()),
      ...
      //std::cout<<"before: "<<goodIsTight<<std::endl;
      ...
      //       std::cout<<"after: "<<goodIsTight<<std::endl;
    ...
    double transverseMass2JESDOWN = TMath::Sqrt( TMath::Power(zp4.Et() + wp4JESDOWN.Et(),2) - TMath::Power(zp4.Px() + wp4JESDOWN.Px(),2) - TMath::Power(zp4.Py() + wp4JESDOWN.Py(),2));
     ...
     double transverseMass2LEPScaleDOWN = TMath::Sqrt( TMath::Power(zp4LEPScaleDOWN.Et() + wp4LEPScaleDOWN.Et(),2) - TMath::Power(zp4LEPScaleDOWN.Px() + wp4LEPScaleDOWN.Px(),2) - TMath::Power(zp4LEPScaleDOWN.Py() + wp4LEPScaleDOWN.Py(),2));
      ...
      // lepton efficiency
      double effSF = 1.0;
      //if(infilecatv[ifile] != 0 && infilecatv[ifile] != 6 && !infilenamev[ifile].Contains("76X")){
        if(infilecatv[ifile] != 0){
         for(unsigned int nl=0; nl<idLep.size(); nl++){
	   if(tagZ[2] != (int)nl)
      ...
      double trigEff = 1.0;
      //if(infilecatv[ifile] != 0) {
      //  trigEff = trigLookup.GetExpectedTriggerEfficiency(((TLorentzVector*)(*eventLeptons.p4)[idLep[0]])->Eta(),((TLorentzVector*)(*eventLeptons.p4)[idLep[0]])->Pt(),((TLorentzVector*)(*eventLeptons.p4)[idLep[1]])->Eta(),((TLorentzVector*)(*eventLeptons.p4)[idLep[1]])->Pt(),TMath::Abs((int)(*eventLeptons.pdgId)[idLep[0]]),TMath::Abs((int)(*eventLeptons.pdgId)[idLep[1]]));
     //}
      //
    ...
    /*  if(infilecatv[ifile] != 0 && infilecatv[ifile] != 6 && infilenamev[ifile].Contains("76X")){
	    ...
	    effSF = effSF * effhDScaleFactor(((TLorentzVector*)(*eventLeptons.p4)[idLep[nl]])->Pt(),
					     ((TLorentzVector*)(*eventLeptons.p4)[idLep[nl]])->Eta(),TMath::Abs((int)(*eventLeptons.pdgId)[idLep[nl]]),
					     typeLepSel.Data(),fhDMuMediumSF_76_80,fhDElMediumSF_76_80,fhDElTightSF_76_80,fhDmutrksfptg10,fhDeltrksf,eventVertex.npv,1);
          else
	    effSF = effSF * effhDScaleFactor(((TLorentzVector*)(*eventLeptons.p4)[idLep[nl]])->Pt(),
					     ((TLorentzVector*)(*eventLeptons.p4)[idLep[nl]])->Eta(),TMath::Abs((int)(*eventLeptons.pdgId)[idLep[nl]]),
					     type3rdLepSel.Data(),fhDMuMediumSF_76_80,fhDElMediumSF_76_80,fhDElTightSF_76_80,fhDmutrksfptg10,fhDeltrksf,eventVertex.npv,1);
        }
      } */
      ...
      //      if(infilecatv[ifile] == 5 && infilenamev[ifile].Contains("WZJJ_EWK_QCD_1")) totalWeight=mcWeight*theLumi*effSF*fakeSF*theMCPrescale * 0.64 * (6./5); // reweight according to data 15% unc. QCD+EWK
      if(infilecatv[ifile] == 3 && infilenamev[ifile].Contains("WZJJ_QCD")) totalWeight=mcWeight*theLumi*effSF*fakeSF*theMCPrescale * 0.64 * (6./5); // reweight according to data 15% unc. QCD+EWK
      if(infilecatv[ifile] == 3 && infilenamev[ifile].Contains("powheg")) totalWeight=mcWeight*theLumi*puWeight*effSF*fakeSF*theMCPrescale; // reweight according to data 15% unc. QCD+EWK
      if(infilecatv[ifile] == 3 && infilenamev[ifile].Contains("WZJJ_EWK_1")) totalWeight = mcWeight*theLumi*puWeight*effSF*fakeSF*theMCPrescale;//mcWeight*theLumi*effSF*fakeSF*theMCPrescale * (6./5); // reweight according to data 15% unc. QCD+EWK      
      ...
      //cout<<fakeSF<<endl;     
      //      cout<<"isTight: "<<goodIsTight<<endl; cout<<"category: "<<theCategory<<endl;
	...
	//        else if(thePlot == 40 && passAllCuts[0])                         {makePlot = true;theVar = (double)type3l;}
	...
	double MVAVarLEPScaleDOWN = TMath::Min(transverseMass2LEPScaleDOWN, 2199.99);
	  ...
	  if(passAllCuts[SIGSEL]) {histo_Data->Fill(MVAVar,totalWeight);
	    cout<<"Event Number "<<eventEvent.eventNum<<endl;
	    if(type3l==0) eventNumbers0.push_back(eventEvent.eventNum);
	    if(type3l==0) runNumbers0.push_back(eventEvent.runNum);
	    if(type3l==0) lsNumbers0.push_back(eventEvent.lumiNum);
	    if(type3l==1) eventNumbers1.push_back(eventEvent.eventNum);
	    if(type3l==1) runNumbers1.push_back(eventEvent.runNum);
	    if(type3l==1) lsNumbers1.push_back(eventEvent.lumiNum);
	    if(type3l==2) eventNumbers2.push_back(eventEvent.eventNum);
	    if(type3l==2) lsNumbers2.push_back(eventEvent.lumiNum);
	    if(type3l==2) runNumbers2.push_back(eventEvent.runNum);
	    if(type3l==3) eventNumbers3.push_back(eventEvent.eventNum);
	    if(type3l==3) lsNumbers3.push_back(eventEvent.lumiNum);
	    if(type3l==3) runNumbers3.push_back(eventEvent.runNum);
	    /*	    cout<<"mjj: "<<(( ( *(TLorentzVector*)(eventJets.p4->At(idJet[0])) ) + ( *(TLorentzVector*)(eventJets.p4->At(idJet[1])) ) )).M()<<endl;
	    cout<<"jet2 pt: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[1]))).Pt()<<endl;
	    cout<<"jet1 pt: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[0]))).Pt()<<endl;

	    cout<<"jet2 pz: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[1]))).Pz()<<endl;
            cout<<"jet1 pz: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[0]))).Pz()<<endl;
	    
	    cout<<"jet2 eta: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[1]))).Eta()<<endl;
            cout<<"jet1 eta: "<<( *(TLorentzVector*)(eventJets.p4->At(idJet[0]))).Eta()<<endl;
	    cout<<"mT: "<<MVAVar<<endl;
	    cout<<type3l<<endl;*/}
	}
	  ...
	  if(passAllCuts[SIGSEL]) {
	    ...
	    //	    if(MVAVar>700.) cout<<"fake weight"<<totalWeight<<endl;
	    /*if     (typeFakeLepton[0] > typeFakeLepton[1]) histo_Fake->Fill(MVAVar,totalWeight);
	  ...
	  if(passAllCuts[SIGSEL]) {
	    ...
	    for(int i=0; i<11; i++) { 
	      if(infilenamev[ifile].Contains("Signal_"+SignalSuffix[i]+"_")){
