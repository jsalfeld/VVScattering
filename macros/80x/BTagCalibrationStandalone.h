...
#ifndef BTagCalibration2_H
#define BTagCalibration2_H

/**
 * BTagCalibration2
 *
 * The 'hierarchy' of stored information is this:
 * - by tagger (BTagCalibration2)
...
class BTagCalibration2
{
public:
  BTagCalibration2() {}
  BTagCalibration2(const std::string &tagger);
  BTagCalibration2(const std::string &tagger, const std::string &filename);
  ~BTagCalibration2() {}
...
#endif  // BTagCalibration2_H


#ifndef BTagCalibration2Reader_H
#define BTagCalibration2Reader_H

/**
 * BTagCalibration2Reader
 *
 * Helper class to pull out a specific set of BTagEntry's out of a
 * BTagCalibration2. TF1 functions are set up at initialization time.
 *
 ************************************************************/
...
class BTagCalibration2Reader
{
public:
  BTagCalibration2Reader() {}
  BTagCalibration2Reader(const BTagCalibration2* c,
...
protected:
  ...
  void setupTmpData(const BTagCalibration2* c);
...
#endif  // BTagCalibration2Reader_H
