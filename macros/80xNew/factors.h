...
double fake_rate_m_25_TightFake[5][6] = {
  0.300,0.265,0.257,0.240,0.219,0.228,
  0.314,0.278,0.266,0.254,0.238,0.244,
  0.357,0.327,0.315,0.295,0.283,0.268,
  0.403,0.381,0.377,0.359,0.341,0.322,
...
double fake_rate_e_25_TightFake[5][6] = {
  0.221,0.289,0.289,0.267,0.262,0.304,
  0.197,0.305,0.280,0.264,0.261,0.312,
  0.197,0.304,0.274,0.274,0.288,0.339,
  0.246,0.245,0.257,0.249,0.253,0.250,
  0.152,0.188,0.191,0.189,0.199,0.213
};
...
double selectIdIsoCut(TString type, int pdgId, double pt, double eta, double iso, int selBits, double mva){
  ...
  if     (TMath::Abs(pdgId) == 13) {
    ...
    if     (type == "medium" || type == "default" || type == "verytight" || type=="veryverytight" || type == "default_mva" || type == "medium_mva") idCut = (selBits & BareLeptons::LepTightIP) == BareLeptons::LepTightIP /*&& (selBits & BareLeptons::LepFake) == BareLeptons::LepFake*/;
    ...
    else if(type == "default")       idCut = (selBits & BareLeptons::LepTightIP) == BareLeptons::LepTightIP && (selBits & BareLeptons::LepFake) == BareLeptons::LepFake;
...
double fakeRateFactor(double pt, double eta, int nsel, int period, TString type){
  ...
  else if(TMath::Abs(nsel) == 11 && period == 1 &&  type== "default")			                                                 return addFactor*fake_rate_e_25_TightFake         [iEta][iPt]/(1.0-fake_rate_e_25_TightFake [iEta][iPt]);
