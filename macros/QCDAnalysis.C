...
void QCDAnalysis(
 ...
 Int_t applyPrescale = 1
  ...
  if     (typeSel == 11) {prescale[0]=0.00000;prescale[1]=0.10334;prescale[2]=0.13980;prescale[3]=0.16113;prescale[4]=0.20749;}
  else if(typeSel == 13) {prescale[0]=0.00000;prescale[1]=0.02713;prescale[2]=0.02853;prescale[3]=0.02952;prescale[4]=0.09362;}
  ...
  for(UInt_t ifile=0; ifile<infilenamev.size(); ifile++) {
	...
	if(idLep.size() == 1 && idTight[0] == 1 &&
	 ...
	 (infilecatv[ifile] == 0 || isGenLep.size() == 1)) {
      ...
      double totalWeight = eventMonteCarlo.mcWeight*theLumi*puWeight*effSF*thePrescale;
