...
TH1D *hDIDilPtMM[nFiles];
TH1D *hDIDilPtEE[nFiles];
TH1D *hDIDilRapMM[nFiles];
TH1D *hDIDilRapEE[nFiles];
TH1D *hDIDilRapPMM[nFiles];
TH1D *hDIDilRapPEE[nFiles];
TH1D *hDIDilRapMMM[nFiles];
TH1D *hDIDilRapMEE[nFiles];
TH1D *hDIDilPtRap0MM[nFiles];
TH1D *hDIDilPtRap0EE[nFiles];
TH1D *hDIDilPtRap1MM[nFiles];
TH1D *hDIDilPtRap1EE[nFiles];
TH1D *hDIDilPtRap2MM[nFiles];
TH1D *hDIDilPtRap2EE[nFiles];
TH1D *hDIDilPtRap3MM[nFiles];
TH1D *hDIDilPtRap3EE[nFiles];
TH1D *hDIDilPtRap4MM[nFiles];
TH1D *hDIDilPtRap4EE[nFiles];
