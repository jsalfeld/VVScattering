...
double trigger_sf(double pt1, double eta1, int pdg1, double pt2, double eta2, int pdg2){
      ...
      if    (TMath::Abs(eta2) < 1.5) iEta[1] = 0;
      else			     iEta[1] = 1;
      ...
      double theSF = 1.0;
      if     (abs(pdg1) == 13 && abs(pdg2) == 13) theSF = effMM[theBin];
      else if(abs(pdg1) == 11 && abs(pdg2) == 11) theSF = effEE[theBin];
      else                                        theSF = effEM[theBin];

      if(abs(pdg1) == 13){
        if     (eta1 > -2.4 && eta1 <= -2.3) theSF = theSF * 0.945;
        else if(eta1 > -2.3 && eta1 <= -1.7) theSF = theSF * 0.970;
        else if(eta1 >  1.7 && eta1 <=  2.3) theSF = theSF * 0.970;
        else if(eta1 >  2.3 && eta1 <=  2.4) theSF = theSF * 0.935;
      }
      if(abs(pdg2) == 13){
        if     (eta2 > -2.4 && eta2 <= -2.3) theSF = theSF * 0.945;
        else if(eta2 > -2.3 && eta2 <= -1.7) theSF = theSF * 0.970;
        else if(eta2 >  1.7 && eta2 <=  2.3) theSF = theSF * 0.970;
        else if(eta2 >  2.3 && eta2 <=  2.4) theSF = theSF * 0.935;
      }
      if(abs(pdg1) == 11){
        if     (eta1 >  2.1 && eta1 <=  2.2) theSF = theSF * 0.980;
        else if(eta1 >  2.2 && eta1 <=  2.3) theSF = theSF * 0.930;
        else if(eta1 >  2.3 && eta1 <=  2.4) theSF = theSF * 0.850;
	if(pt1 < 45 && eta1 >  -2.4 && eta1 <=  -2.2) theSF = theSF * 0.960;
	if(pt1 > 35 && pt1 < 45 && eta1 > 2.3 && eta1 <= 2.4) theSF = theSF * 0.980;
      }
      if(abs(pdg2) == 11){
        if     (eta2 >  2.1 && eta2 <=  2.2) theSF = theSF * 0.980;
        else if(eta2 >  2.2 && eta2 <=  2.3) theSF = theSF * 0.930;
        else if(eta2 >  2.3 && eta2 <=  2.4) theSF = theSF * 0.850;
	if(pt2 < 45 && eta2 >  -2.4 && eta2 <=  -2.2) theSF = theSF * 0.960;
	if(pt2 > 35 && pt2 < 45 && eta2 > 2.3 && eta2 <= 2.4) theSF = theSF * 0.980;
      }
